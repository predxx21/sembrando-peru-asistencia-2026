...
export async function terminarSesionCronometro({ profileId }) {
  try {
    ...
    // 🔒 Validar duración mínima (evita registros con 0 horas)
    if (horas <= 0) {
      return {
        data: null,
        error: { message: 'La duración debe ser mayor a 0 segundos.', status: 400 },
      };
    }
...
// ============================================================
//  REGISTROS MANUALES (se usan para creación manual desde el endpoint POST /api/registros)
// ============================================================
