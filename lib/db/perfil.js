...
// Actualiza los datos editables del perfil (nombre/apellido/area) de un usuario
// ya autenticado. Se usa desde la pantalla "Editar Perfil".
export async function actualizarPerfil({ id, nombre, apellido, area }) {
  try {
    const profile = await prisma.profile.update({
      where: { id },
      data: { nombre, apellido, area: area || null },
    });
