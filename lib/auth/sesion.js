...
// Página de inicio según el rol: admin o coordinador_general → administración,
// resto (voluntario) → principal.
export function rutaPorRol(rol) {
  return (rol === 'admin' || rol === 'coordinador_general') ? '/administracion' : '/principal';
}
