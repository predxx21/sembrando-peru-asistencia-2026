...
// ¿La hora fin es estrictamente posterior a la hora inicio?
// Acepta cruce de medianoche (ej. "22:00" → "06:00" = válido, 8h).
// Devuelve false si alguna es inválida o si son iguales.
export function esHoraFinMayorAInicio(horaInicio, horaFin) {
  if (!esHoraValida(horaInicio) || !esHoraValida(horaFin)) return false;
  ...
  // Igual → inválido. Fin anterior (sin cruce medianoche) → inválido.
  // Fin posterior O cruce de medianoche → válido.
