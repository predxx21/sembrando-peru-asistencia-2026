...
// Nombre del archivo de evidencia a partir de su ruta en el bucket privado.
export function nombreEvidencia(evidenciaUrl) {
  return evidenciaUrl ? evidenciaUrl.split('/').pop() : 'Sin evidencia';
}